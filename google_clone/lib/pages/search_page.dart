...
import 'package:google_clone/pages/widgets/search_footer.dart';
import 'package:google_clone/pages/widgets/search_header.dart';
import 'package:google_clone/pages/widgets/search_result_component.dart';
import 'package:google_clone/pages/widgets/search_tabs.dart';
import 'package:google_clone/services/api_services.dart';

class SearchPage extends StatelessWidget {
  final String searchQuery;
  final String start;
  const SearchPage({Key? key, required this.searchQuery, this.start = '0'})
      : super(key: key);
